...
4. Checks all configured directories for an existing file with the same `import`
   URL and warns before creating a duplicate
5. Commits to the configured path
...
1. An author installs the CLI and sets up a .corpo directory
